            ...
            <div className='flex md:flex-row sm:flex-col md:items-start sm:items-center max-sm:items-center max-sm:flex-col gap-[40px]'>
                <section>
                    <form className='max-w-[685px]'>
                        <p className='mb-6'>Already have an account? <Link href={"/login"} className='text-primary font-semibold underline-offset-4 underline'>Sing In</Link></p>
                        <ProfileForm loginType='Register' />
