    ...
    return (
        <main className="max-w-[1240px] mx-auto mt-[62px] px-3">
            ...
            {tickets.length ? <>
                ...
                <div className="mb-[78px] flex justify-between md:flex-row sm:flex-col gap-3 max-sm:gap-12 max-sm:flex-col h-full">
                    <section className=" md:w-[715px] sm:w-full flex flex-col gap-[40px] h-full">
