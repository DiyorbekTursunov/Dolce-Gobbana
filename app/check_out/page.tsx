                ...
                <form className=" md:w-[715px] sm:w-full flex flex-col gap-[40px] h-full">
                    <div className="border-[1px] border-[#0000001A] rounded-[6px] py-[20px] px-6  flex flex-col h-full">
                        ...
                        <div className='flex flex-col gap-6'>
                            <div className='flex flex-wrap items-center gap-2 bg-[#EFF6FF] py-3 px-4 rounded-[6px]'>
                                <div className='flex gap-2'>
                                    <Image src={lock_outlined_icon} alt='lock outlined icon' />
                                    <span>
                                        Payments are secured. We accept
                                    </span>
                                </div>
            ...
            <div className='w-full border-[1px] border-[#0000001A] rounded-[6px] p-6'>
                ...
                {descrIsOpen && (
                    <div className="mt-6">
                        ...
                        <ul className="mt-3 ml-6 flex flex-col gap-3 max-sm:text-[12px]">
                            <li>
